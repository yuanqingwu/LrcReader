...
public class UrlConstant {
    ...
    public static final String NAME_LRC_URL_ROOT = "http://gecimi.com/api/lyric/";

    /**
     * 根据歌手编号获取歌手信息（暂时只有歌手名字）:'http://geci.me/api/artist/9208'
     */
    public static final String ARTIST_URL_ROOT = "http://gecimi.com/api/artist/";

    /**
     * 根据歌曲编号获取歌词URL：'http://geci.me/api/lrc/3861244'
     */
    public static final String SID_LRC_URL_ROOT = "http://gecimi.com/api/lrc/";
